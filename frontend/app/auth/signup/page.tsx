    ...
    <div className="min-h-screen bg-background-primary flex items-center justify-center p-8">
      <div className="w-full max-w-[420px] space-y-8">
        ...
        <form className="space-y-5">
                ...
                {[0, 25, 50, 75, 100].map((threshold) => (
                  <div
                    ...
                    className={`flex-1 rounded-full transition-colors ${
                      passwordStrength >= threshold ? getStrengthColor(passwordStrength) : 'bg-background-tertiary'
                    }`}
                  />
                ))}
              </div>
              <div className="flex justify-between items-center">
                <span className="text-caption text-text-tertiary uppercase tracking-[0.05em]">
          ...
          <div className="space-y-2">
            <label className="text-caption font-bold text-text-secondary uppercase tracking-[0.05em] ml-1">Confirm Password</label>
            <div className="relative group">
              <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-text-tertiary group-focus-within:text-primary transition-colors" />
              <input 
