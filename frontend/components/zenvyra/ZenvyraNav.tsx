...
import { MAIN_NAV, PRODUCTS_MEGA, type NavMegaColumn } from "@/lib/zenvyra-nav";
import { ZenvyraButton } from "./ZenvyraButton";
...
function MegaMenuPanel({
  ...
  return (
    <div
      ...
      className="absolute left-1/2 -translate-x-1/2 top-full z-50 w-[600px] rounded-2xl border border-all-border-strong bg-white p-6 shadow-zenvyra-soft"
      role="region"
...
/* ─── Navbar ─── */
export default function ZenvyraNav() {
    ...
    >
      <div className="mx-auto flex h-[72px] max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <Link href="/" className="flex shrink-0 items-center gap-2 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-text">
          ...
          <span className="text-xl font-black tracking-tight text-all-surface">&nbsp;Zenvyra</span>
        </Link>
