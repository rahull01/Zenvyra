...
const zenvyraButtonVariants = cva(
...
export interface ZenvyraButtonProps
  extends React.ButtonHTMLAttributes<HTMLButtonElement>,
    VariantProps<typeof zenvyraButtonVariants> {
  asChild?: boolean;
  loading?: boolean;
}

const ZenvyraButton = React.forwardRef<HTMLButtonElement, ZenvyraButtonProps>(
  ({ className, variant, size, asChild = false, loading, children, disabled, ...props }, ref) => {
    const Comp = asChild ? Slot : "button";
    return (
      <Comp
        className={cn(zenvyraButtonVariants({ variant, size, className }))}
        ref={ref}
...
ZenvyraButton.displayName = "ZenvyraButton";

export { ZenvyraButton, zenvyraButtonVariants };
