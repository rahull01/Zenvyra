...
const ProductShowcase = () => {
  const features = [
    'AI system inventory with EU exposure, provider, use case, oversight, and logging fields',
    'Readiness assessments for transparency, documentation, human review, and data handling gaps',
    'Supporting scans for cookies, trackers, policies, DSAR, and US privacy notices',
    'Team activity, audit notes, public proof, and client handoff packets in one workspace',
  ];
          ...
          >
            <div className="rounded-[32px] border border-border-light bg-slate-950/95 shadow-2xl overflow-hidden">
              <div className="bg-slate-900/90 px-6 py-5 border-b border-white/10 flex items-center justify-between">
                <div>
                <p className="text-sm font-semibold uppercase tracking-[0.18em] text-white/70">AI readiness workspace</p>
              ...
              <div className="space-y-6 p-6">
                <div className="rounded-[28px] border border-white/10 bg-slate-900/90 p-6">
                  <div className="flex items-center justify-between gap-4">
                    <div>
                      <p className="text-sm text-white/70">AI Act evidence</p>
                      <p className="mt-2 text-xl font-semibold text-white">Counsel ready</p>
                    </div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="rounded-[28px] border border-white/10 bg-slate-900/90 p-5">
                    ...
                    <p className="mt-3 text-lg font-semibold text-white">Drafted</p>
                  </div>
                  <div className="rounded-[28px] border border-white/10 bg-slate-900/90 p-5">
                    <p className="text-sm text-white/70">Oversight gaps</p>
                ...
                <div className="rounded-[28px] border border-white/10 bg-slate-900/90 p-5">
                  <div className="flex items-center justify-between gap-4">
                    <div>
                      <p className="text-sm text-white/70">Next review</p>
          ...
          >
            <div className="space-y-6">
              ...
              <h2 className="text-h2 font-extrabold text-text-primary">
                A dashboard designed around AI readiness, not guesswork
              </h2>
              <p className="max-w-2xl text-body-lg text-text-secondary leading-relaxed">
                Give your team one place to understand each AI system, what evidence is missing,
                what privacy proof supports it, and which items need legal or technical review.
              </p>
            </div>
