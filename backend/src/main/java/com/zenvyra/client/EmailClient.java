...
public class EmailClient {
    ...
    public void sendSimpleEmail(String to, String subject, String text) {
        try {
            ...
            log.info("Simple email sent to {}", LogSanitizer.email(to));
        } catch (Exception e) {
            log.error("Failed to send simple email to {}", LogSanitizer.email(to), e);
    ...
    public void sendHtmlEmail(String to, String subject, String htmlContent) {
        try {
            ...
            mailSender.send(message);
            log.info("HTML email sent to {}", LogSanitizer.email(to));
        } catch (Exception e) {
            log.error("Failed to send HTML email to {}", LogSanitizer.email(to), e);
    ...
    public void sendEmailWithAttachment(String to, String subject, String text, String attachmentName,
        ...
        try {
            ...
            mailSender.send(message);
            log.info("Email with attachment sent to {}", LogSanitizer.email(to));
        } catch (Exception e) {
            log.error("Failed to send email with attachment to {}", LogSanitizer.email(to), e);
