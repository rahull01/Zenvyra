        ...
        for (Website website : websites) {
            try {
                ...
                if (previousHash != null && !previousHash.equals(currentHash)) {
                    log.info("Change detected on {}", LogSanitizer.url(website.getUrl()));
                ...
                log.error("Failed to detect changes for {}: {}", LogSanitizer.url(website.getUrl()), LogSanitizer.exception(e));
            }
        }
