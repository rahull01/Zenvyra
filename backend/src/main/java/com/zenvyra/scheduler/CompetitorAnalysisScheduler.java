...
import com.zenvyra.repository.CompetitorRepository;
...
public class CompetitorAnalysisScheduler {
    ...
    public void runWeeklyCompetitorAnalysis() {
        ...
        for (Competitor competitor : competitors) {
            try {
                log.info("Analyzing competitor {}", LogSanitizer.url(competitor.getUrl()));
                ...
                log.error("Failed to analyze competitor {}: {}", LogSanitizer.url(competitor.getUrl()), LogSanitizer.exception(e));
            }
        }
